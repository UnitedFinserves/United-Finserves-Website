...
const allServices = [
  ...
  { id: 'mortgage-loan',       title: 'Mortgage / LAP',       desc: 'Unlock the full value of your property to secure substantial funding at the lowest possible rates.',               icon: FaCity,         color: 'from-amber-500 to-amber-700'   },
  ...
  return (
    <div className="bg-[#F4F7FB] min-h-screen">
      ...
      <div className="relative pt-32 pb-28 bg-brand-navy overflow-hidden">
        ...
        {/* Floating orbs */}
        <div className="absolute top-10 right-24 w-72 h-72 bg-brand-gold/10 rounded-full blur-3xl animate-pulse" />
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
            ...
            Financial Services<br /><span className="text-brand-gold">Built for You</span>
          </motion.h1>
      ...
      <div className="py-24 max-w-[1400px] mx-auto px-6 lg:px-16">
        <div className="text-center mb-16">
          <span className="text-brand-gold font-black uppercase tracking-widest text-xs mb-3 block">All Services</span>
          ...
          {allServices.map((svc, index) => {
            ...
            return (
              <motion.div key={svc.id} {...fadeUp} transition={{ duration: 0.4, delay: index * 0.05 }}
                ...
                <Link to="/contact"
                  className="inline-flex items-center gap-2 text-sm font-bold text-brand-navy group-hover:text-brand-gold transition-colors">
      ...
      <div className="bg-brand-navy py-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(240,165,0,0.1),transparent_70%)]" />
        <div className="relative z-10 text-center px-6">
          ...
          <Link to="/contact"
            className="inline-block px-10 py-4 bg-brand-gold hover:bg-amber-500 text-white font-extrabold rounded-2xl shadow-xl shadow-brand-gold/30 hover:-translate-y-1 transition-all duration-300 text-lg">
            Book a Free Call →
          </Link>
        </div>
      </div>
